...
//counting size and printing
  ...
  System.out.println(al.lastIndexOf("a"));//something wrong
  System.out.println(al.lastIndexOf(true));//something wrong
  System.out.println(al.indexOf(true));
 // al.add(7, "p"); size problem 
 ...
 /*  System.out.println(al.remove(0));
  ...
  System.out.println(al);
  System.out.println("size:"+al.size());
  al.add(1, 0.9); //in the middle of array inserting
  
  
  System.out.println(al);
  System.out.println("size:"+al.size());
  
  //Collections.sort(al1);  giving error--not for heterogenous objs may be
 ...
 // System.out.println(al2.retainAll(al1));//correct
  ...
  //to make arraylist a syncronized
